...
@section('content')
   <div class="getStartedContainer clearfix">
     <div class="getStartedLeft">
        ...
        <a href="{{ env('APP_URL') .env('COMPANIES_LOGIN_URL') }}" class='getStartedCompany' style="b ackground-image:linear-gradient(270deg, #f5cbf5 0%, #a9e7df 100%)">
...
text-align: center;"> We are the market–leading technical interview platform to identify and hire developers with the right skills.</p>
        ...
        <a href="{{ env('APP_URL') .env('DEVELOPERS_LOGIN_URL') }}" class='getStartedDeveloper' style="width:93%;b ackground-image: linear-gradient(270deg, #f5cbf5 0%, #8EC5FC 100%);">
