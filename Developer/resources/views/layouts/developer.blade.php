...
<body style="background:#f3f7f7">
    <div class="top-header">
        <div class="container">
            <a href="{{ env("APP_URL") .env("LANDING_PAGE_URL") }}"><img src="/files/images/loog.png" alt=""></a>
            <ul>
                ...
                <div class="dropdown-body">
                    ...
                    <ul>
                        ...
                        @if(Illuminate\Support\Facades\Auth::user()->role == 'C' )
                            <li><a href="{{ env('APP_URL') .env('COMPANY_LOGIN_DASHBOARD_URL') }}"><i class="fas fa-clipboard-list"></i>Dashboard</a></li>
                            <li><a href="{{ env('APP_URL') . env('COMPANY_LOGIN_PROFILE_URL') }}"><i class="far fa-address-card"></i>Profile</a></li>
                            <li><a href="{{ env('APP_URL') . env('COMPANY_LOGIN_LOGOUT_URL') }}"><i class="fas fa-sign-out-alt"></i>Logout</a></li>
                        @endif
                    </ul>
                </div>
            </div>
